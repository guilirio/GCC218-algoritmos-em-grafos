...
class initialSolution:
    ...
    def write_solution(self, output_file):
        with open(output_file, "w") as f:
            ...
            f.write("14561498\n")                       # Linha 3: Clocks fixos
            f.write("64474\n")                          # Linha 4: Clocks fixos
...
def process_all_instances(selected_folder="selected_instances", output_folder="solucoes_problema", vehicle_capacity=30):
